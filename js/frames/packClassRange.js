...
availableFrames = [
	...
	{name:'White Regular Frame', src:'/img/frames/class/w.png', masks:masks},
	{name:'Blue Regular Frame', src:'/img/frames/class/u.png', masks:masks},
	{name:'Black Regular Frame', src:'/img/frames/class/b.png', masks:masks},
	{name:'Red Regular Frame', src:'/img/frames/class/r.png', masks:masks},
	{name:'Green Regular Frame', src:'/img/frames/class/g.png', masks:masks},
	{name:'Multicolored Regular Frame', src:'/img/frames/class/m.png', masks:masks},
	{name:'Artifact Regular Frame', src:'/img/frames/class/a.png', masks:masks},
	{name:'Land Regular Frame', src:'/img/frames/class/l.png', masks:masks},
	{name:'Colorless Regular Frame', src:'/img/frames/class/c.png', masks:masks}
];
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'classRange';
	card.onload = '/js/frames/versionClassRange.js';
	await loadScript('/js/frames/versionClassRange.js');
	//art bounds
