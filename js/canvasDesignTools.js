(function () {
	...
	function applyEditor(event) {
		...
		if(geometry[id]){
			...
			if(window.RulesRange)RulesRange.snapBounds(target,axis==='x'?'left':axis==='y'?'top':axis==='width'?'right':'bottom',range?.id);
