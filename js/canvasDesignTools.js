(function () {
	...
	function buildUI(){
		...
		document.body.insertAdjacentHTML('beforeend',`<div class="canvas-design-toolbar"><button class="input active" data-canvas-tool="select">Select</button><button class="input" data-canvas-tool="text">Text</button><button class="input" data-canvas-tool="image">Image</button><button class="input" data-canvas-tool="range">Range</button></div><div id="canvas-design-menu" class="canvas-design-menu"><button class="input" data-create="text">Add Text Box Here</button><button class="input" data-create="image">Add Image Container Here</button><button class="input" data-create="range">Add Rules Range Here</button></div><div id="canvas-design-draft" class="canvas-design-draft"></div><div id="canvas-element-editor" class="canvas-element-editor"><h2 id="canvas-element-title" class="canvas-element-editor-title">Element</h2><h2 class="canvas-element-editor-close">X</h2><label class="wide">Name<input id="canvas-element-name" class="input"></label><label>X<input id="canvas-element-x" class="input" type="number"></label><label>Y<input id="canvas-element-y" class="input" type="number"></label><label>Width<input id="canvas-element-width" class="input" type="number" min="10"></label><label>Height<input id="canvas-element-height" class="input" type="number" min="10"></label><label>Rotation<input id="canvas-element-rotation" class="input" type="number"></label><label id="canvas-element-flow-row">Module Flow<select id="canvas-element-flow" class="input"><option value="vertical">Vertical</option><option value="horizontal">Horizontal</option></select></label><label id="canvas-element-auto-row" class="wide">Auto-size modules to text<input id="canvas-element-auto-size" type="checkbox"></label><label id="canvas-element-uniform-row" class="wide">Uniform text size across modules<input id="canvas-element-uniform-text" type="checkbox"></label><button id="canvas-element-full" class="input wide">Open Full Editor</button></div>`);
